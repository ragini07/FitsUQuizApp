...
function CategoryQuiz() {
    ...
    const { quizState, dispatchQuizState , categorySelected , setCategorySelected} = useData()
  ...
  return (
    ...
    <div className="category-container">
        {
           loading ? <div>Loading...</div> : quizzesByCategory.map(({_id,title,imageUrl,totalScore,mcqs}) => {
                return (
                    ...
                    <div className="card-desc">
                        ...
                        <p><i className="fa fa-tag"></i>{mcqs.length} Questions</p>
                    </div> 
